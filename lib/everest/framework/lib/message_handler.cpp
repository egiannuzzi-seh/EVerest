...
MessageHandler::MessageHandler() {
    operation_thread_pool =
        std::make_unique<ThreadPool>(THREAD_POOL_SCALING_MIN_THREAD_COUNT, std::thread::hardware_concurrency(),
                                     THREAD_POOL_SCALING_IDLE_TIMEOUT, 0, everest::lib::util::ExceptionPolicy::Rethrow);
